...
description: Writeup de Oopsie en HackTheBox Starting Point. Manipulación de cookies para escalada de privilegios y explotación de binarios SUID en Linux con PHP.
