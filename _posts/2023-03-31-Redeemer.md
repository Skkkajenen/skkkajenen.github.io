...
description: Writeup de Redeemer en HackTheBox Starting Point. Explota un servicio Redis expuesto sin autenticación para obtener la flag en una máquina Linux.
