...
description: Writeup de Dancing en HackTheBox Starting Point. Explota recursos compartidos SMB mal configurados para acceder a los archivos de una máquina Windows.
