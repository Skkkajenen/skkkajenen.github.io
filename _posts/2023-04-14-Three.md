...
description: Writeup de Three en HackTheBox Starting Point. Explota un bucket AWS S3 mal configurado para ejecutar código PHP de forma remota (RCE) en Linux.
